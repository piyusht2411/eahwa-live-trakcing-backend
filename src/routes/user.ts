...
import { deleteUser, getAdminsAndManagers, getAllUsers, getUserById, updateUser, getUsersHomeLocations, getUserTravelHistory } from "../controllers/userController";
...
router.get("/:id/travel-history", protect, authorize("admin", "hr", "manager"), getUserTravelHistory);
